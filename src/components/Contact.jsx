            ...
            <div className="mb-8">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="https://github.com/Eslam99Emam/" className="bg-gray-700 p-2 rounded-md text-green-400 hover:bg-gray-600 transition">
                  ...
                  <a href="https://www.linkedin.com/in/eslam-emam-hussien" className="bg-gray-700 p-2 rounded-md text-green-400 hover:bg-gray-600 transition">
                  ...
                  <a href="https://linktr.ee/eslam.emam.hussien" className="bg-gray-700 p-2 rounded-md text-green-400 hover:bg-gray-600 transition">

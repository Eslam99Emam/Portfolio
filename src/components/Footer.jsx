      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-gray-400 mt-2">Flutter Developer creating beautiful mobile experiences</p>
          </div>

          <div className="flex flex-col items-center md:items-end">
            <div className="flex space-x-4 mb-4">
              <a href="https://github.com/Eslam99Emam/" className="text-gray-400 hover:text-green-400 transition">
              ...
              <a href="https://www.linkedin.com/in/eslam-emam-hussien" className="text-gray-400 hover:text-green-400 transition">
              ...
              <a href="https://linktr.ee/eslam.emam.hussien" className="text-gray-400 hover:text-green-400 transition">
            ...
            <p className="text-gray-500 text-sm">© {currentYear} Eslam Emam. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
